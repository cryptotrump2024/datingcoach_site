    ...
    >
      ...
      >
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-display-hero text-[#F5F5F7] mb-2"
        >
        ...
        <motion.h1
          ...
          initial="hidden"
          animate="visible"
          className="text-display-hero gradient-text-rose mb-8"
        >
          Win the Date.
        </motion.h1>
        ...
        <motion.p
          ...
          initial="hidden"
          animate="visible"
          className="text-body-lg text-[#A1A1AA] max-w-[640px] mb-10 leading-[1.7]"
        >
        ...
        >
          <Link
            to="/create"
            className="flex items-center gap-2 btn-gradient text-[#F5F5F7] text-heading-sm font-semibold px-9 py-4 rounded-full"
          >
          ...
          <a
            href="#how-it-works"
            className="flex items-center gap-2 text-heading-sm font-semibold text-[#A1A1AA] px-9 py-4 rounded-full border border-[rgba(255,255,255,0.12)] hover:border-[rgba(255,255,255,0.25)] transition-colors"
          >
            See How It Works
          </a>
        </motion.div>
...
function TrustBarSection() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-caption text-[#52525B] uppercase tracking-[0.2em]">Trusted By Leading Publications</span>
      </motion.div>
      ...
      <motion.div
        ...
        className="flex justify-center items-center gap-12 md:gap-20 mt-10"
      >
        {[
          { value: '8.5K+', label: 'Active Users' },
          { value: '180K+', label: 'Conversations Practiced' },
          { value: '4.8', label: 'Average Rating' },
        ].map((stat) => (
          <div key={stat.label} className="text-center">
            <div className="text-heading-lg font-bold text-[#F5F5F7]">{stat.value}</div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h2 className="text-display-subsection text-[#F5F5F7]">How It Works</h2>
        </motion.div>

        {/* ── Individual Step Cards (Phases 1-3) */}
        <motion.div
        ...
        >
          {steps.map((step, i) => (
            <motion.div
              ...
              className={`${i > 0 ? 'absolute inset-0' : 'relative'}`}
            >
              {/* Decorative step number */}
              <div
                className="absolute -top-20 left-1/2 -translate-x-1/2 text-display-hero font-display pointer-events-none select-none"
              ...
              >
                ...
                <h3 className="text-heading-lg text-[#F5F5F7] mb-4">{step.title}</h3>
                <p className="text-body text-[#A1A1AA] leading-relaxed">{step.desc}</p>
              </div>
            </motion.div>
          ))}
        </motion.div>

        {/* ── Phase 4: All Steps Stacked */}
        <motion.div
...
/* ═══════════════════════════════════════════
   ...
   ═══════════════════════════════════════════ */
const personas = [
  { name: 'Sophia', age: 28, ethnicity: 'Italian-American', personality: ['Warm', 'Playful'], difficulty: 'Intermediate', image: '/persona-sophia.jpg', color: '#F59E0B' },
  { name: 'Maya', age: 30, ethnicity: 'South Asian', personality: ['Intellectual', 'Sophisticated'], difficulty: 'Advanced', image: '/persona-maya.jpg', color: '#F97316' },
  { name: 'Chloe', age: 24, ethnicity: 'French', personality: ['Mysterious', 'Romantic'], difficulty: 'Expert', image: '/persona-chloe.jpg', color: '#10B981' },
  { name: 'Ava', age: 26, ethnicity: 'East Asian', personality: ['Creative', 'Artistic'], difficulty: 'Advanced', image: '/persona-ava.jpg', color: '#8B5CF6' },
  { name: 'Zara', age: 32, ethnicity: 'Middle Eastern', personality: ['Confident', 'Direct'], difficulty: 'Expert', image: '/persona-zara.jpg', color: '#EF4444' },
  { name: 'Luna', age: 22, ethnicity: 'Latina', personality: ['Energetic', 'Passionate'], difficulty: 'Beginner', image: '/persona-luna.jpg', color: '#EC4899' },
  { name: 'Isabella', age: 27, ethnicity: 'Brazilian', personality: ['Passionate', 'Dancer'], difficulty: 'Intermediate', image: '/persona-isabella.jpg', color: '#D946EF' },
  { name: 'Natasha', age: 31, ethnicity: 'Russian', personality: ['Direct', 'Sophisticated'], difficulty: 'Advanced', image: '/persona-natasha.jpg', color: '#6366F1' },
  { name: 'Priya', age: 24, ethnicity: 'Indian', personality: ['Warm', 'Family-oriented'], difficulty: 'Beginner', image: '/persona-priya.jpg', color: '#F97316' },
  { name: 'Elena', age: 29, ethnicity: 'Spanish', personality: ['Fiery', 'Independent'], difficulty: 'Expert', image: '/persona-elena.jpg', color: '#EF4444' },
  { name: 'Yuki', age: 25, ethnicity: 'Japanese', personality: ['Quiet', 'Artistic'], difficulty: 'Intermediate', image: '/persona-yuki.jpg', color: '#06B6D4' },
  { name: 'Amina', age: 26, ethnicity: 'Nigerian', personality: ['Confident', 'Ambitious'], difficulty: 'Advanced', image: '/persona-amina.jpg', color: '#8B5CF6' },
]

function PersonaCard({ persona }: { persona: typeof personas[0] }) {
  return (
    <div className="glass-card-elevated overflow-hidden transition-all duration-300 hover:-translate-y-2 hover:shadow-glow-rose flex-shrink-0 w-[260px] md:w-[280px]">
      {/* Image */}
      <div className="aspect-[3/4] overflow-hidden" style={{ maxHeight: '240px' }}>
        <img
          src={persona.image}
          alt={persona.name}
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-1">
          <h3 className="text-heading-sm text-[#F5F5F7]">{persona.name}</h3>
          <span
        ...
        <p className="text-body-sm text-[#52525B] mb-2">
        ...
        <div className="flex flex-wrap gap-1.5 mb-3">
          {persona.personality.map((trait) => (
            <span
              key={trait}
              className="text-body-sm text-[#A1A1AA] px-2.5 py-1 rounded-full"
        ...
        <Link
          to="/create"
          className="inline-flex items-center gap-1.5 btn-gradient text-[#F5F5F7] text-body-sm font-semibold px-4 py-2 rounded-full"
        >
          Practice
        </Link>
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <motion.h2
            ...
            initial="hidden"
            animate={isInView ? 'visible' : 'hidden'}
            className="text-display-subsection text-[#F5F5F7] mb-4"
          >
          ...
          <motion.p
            ...
            initial="hidden"
            animate={isInView ? 'visible' : 'hidden'}
            className="text-body-lg text-[#A1A1AA] max-w-[560px] mx-auto"
          >
      ...
      >
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto px-6 w-full">
          ...
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <motion.div
              style={{ opacity: labelOp }}
              className="flex-1 lg:max-w-[45%] w-full glass-panel p-6 space-y-4"
            >
              {messages.map((msg, i) => (
                <motion.div
                  key={i}
            ...
            <div className="flex-1 lg:max-w-[50%] w-full space-y-4">
              {panels.map((panel, i) => (
                <motion.div
                  key={i}
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h4 className="text-heading-md text-[#F5F5F7] mb-2">{panel.title}</h4>
                      <p className="text-body-sm text-[#A1A1AA] leading-relaxed">{panel.content}</p>
                    </div>
                  </div>
                  <div
      ...
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            className="text-body-lg text-[#A1A1AA]"
          >
            ...
            <div className="flex gap-6" style={{ width: 'max-content' }}>
              {testimonials.map((t, i) => (
                <motion.div
                  ...
                  className="glass-card p-8 w-[300px] md:w-[360px] flex-shrink-0"
                  style={{ scrollSnapAlign: 'start' }}
                >
                  {/* Stars */}
                  ...
                  {/* Quote */}
                  <p className="text-body text-[#F5F5F7] italic leading-[1.7] mb-6">
                    &ldquo;{t.quote}&rdquo;
                  </p>
    ...
    >
      ...
      <div className="relative z-10 max-w-[700px] mx-auto px-6 text-center">
        <motion.h2
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5, ease: easeOutExpo }}
          className="text-display-section text-[#F5F5F7] mb-4"
        >
        ...
        <motion.p
          ...
          animate={isInView ? { opacity: 1, y: 0 } : {}}
          transition={{ duration: 0.5, delay: 0.1, ease: easeOutExpo }}
          className="text-body-lg text-[#A1A1AA] mb-10"
        >
          Join 8,500+ guys who are practicing smarter, not harder.
        </motion.p>
        ...
        >
          <Link
            to="/create"
            className="inline-flex items-center gap-2 btn-gradient text-[#F5F5F7] text-heading-sm md:text-heading-md font-semibold px-11 py-4 rounded-full animate-pulse-scale"
          >
